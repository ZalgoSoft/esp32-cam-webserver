...
void debugOn() {
    debugData = true;
    Log.println("Camera debug data is enabled (send 'd' for status dump, or any other char to disable debug)");
}
...
void Task1Core0 (void * pvParameters ){
  Log.print("Task1Core0 start CPU ");
